...
var lbomin = new Pakiman("Lobomani", 150, 50);
var perrauro = new Pakiman("Perrauro", 160, 50);
...
coleccion.push(new Pakiman("Lobomani", 150, 50));
coleccion.push(new Pakiman("Perrauro", 160, 50));
